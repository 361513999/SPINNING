...
public class AxisYView_LevelType extends View {
    ...
    public void initValue(int Height) {
        ...
        yPoint = Height ;
        yLengh = Height ;
        yLableArray = LineUtils.yScaleArray;
        this.levelName = LineUtils.levelName;
    ...
    private void drawLelveBitmap(Canvas canvas) {
        ...
        for(int i = 0; i< LineUtils.yScaleColors.length; i++){
        	paint.setColor(LineUtils.yScaleColors[i]);
